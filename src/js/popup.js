...
function updateHue() {
  ...
  chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
    chrome.tabs.sendMessage(tabs[0].id, {hueValue: parseInt(hueSlider.value, 10), saturationValue: parseInt(saturationSlider.value, 10), valueValue: parseInt(valueSlider.value, 10)});
  });
}
